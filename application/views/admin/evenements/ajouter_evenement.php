        ...
        <?php echo form_open("", $attributs); ?>
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8"><input type="text" id="nom" name="nom" required="required" value="<?php echo set_value('nom'); ?>" class="form-control"></div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8"><input type="text" id="code_iframe" name="code_iframe" value="<?php echo set_value('code_iframe'); ?>" class="form-control"></div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8"><input type="text" id="lien_evenement" name="lien_evenement" value="<?php echo set_value('lien_evenement'); ?>" class="form-control"></div>
                </div>
            </fieldset>
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6"><input id="date" class="date form-control" required="required" type="text" name="date" value="<?php echo set_value('date'); ?>" data-parsley-id="8840"></div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6"><input id="heure_debut" class="heure_debut form-control" required="required" type="text" name="heure_debut" value="<?php echo set_value('heure_debut'); ?>" data-parsley-id="8840"></div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-6"><input id="heure_fin" class="heure_fin form-control" required="required" type="text" name="heure_fin" value="<?php echo set_value('heure_fin'); ?>" data-parsley-id="8840"></div>
                </div>
            </fieldset>
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8"><input type="text" id="adresse_postale" name="adresse_postale" value="<?php echo set_value('adresse_postale'); ?>" class="form-control"></div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8"><input type="text" id="code_postal" name="code_postal" value="<?php echo set_value('code_postal'); ?>" class="form-control"></div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-8"><input type="text" id="ville" name="ville" value="<?php echo set_value('ville'); ?>" class="form-control"></div>
                </div>
            </fieldset>
