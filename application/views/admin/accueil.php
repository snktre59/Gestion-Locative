<h2 class="page-title">Tableau de bord <small>//</small></h2>
<?php $messages ?>
        <div class="row">
            <div class="col-lg-8">
                <section class="widget">
                    <header>
                        ...
                        <div class="widget-controls">
                            ...
                            <a data-widgster="expand" title="Expand" href="index.html#"><i class="glyphicon glyphicon-chevron-up"></i></a>
                            <a data-widgster="collapse" title="Collapse" href="index.html#"><i class="glyphicon glyphicon-chevron-down"></i></a>
                ...
                <section class="widget">
                    <header>
                        ...
                        <div class="widget-controls">
                            <a data-widgster="expand" title="Expand" href="index.html#"><i class="glyphicon glyphicon-plus"></i></a>
                            <a data-widgster="collapse" title="Collapse" href="index.html#"><i class="glyphicon glyphicon-minus"></i></a>
                            <a data-widgster="close" title="Close" href="index.html#"><i class="glyphicon glyphicon-remove"></i></a>
                        </div>
                    </header>
                    <div class="body">
